...
<input type="hidden" name="edit_id" value="<?php echo $row['id'] ?>">
    ...
    <p style="margin-left: 174px;">
        ...
        <input type="text" name="edit_parent_company_name" value="<?php echo $row['parent_company_name'] ?>"
    ...
    <p style="margin-left: 174px;">
        ...
        Client&nbsp;<input type="radio" name="company_type" value="Client"
            <?php if($row['company_type']=="Client"){ echo "checked";}?> id="Gender"
            style="    margin-left: 10px;">&nbsp;&nbsp;
        Vendor&nbsp;<input type="radio" name="company_type" value="Vendor"
            <?php if($row['company_type']=="Vendor"){ echo "checked";}?> id="Gender">
    </p>
    <hr class="solid">
